/*Função: O programa serve como uma forma do usuário controlar seu acervo pessoal de livros. 
A partir do menu, o usuário consegue cadastrar novos livros, consultar os livros que já possui, excluir e alterar.*/
